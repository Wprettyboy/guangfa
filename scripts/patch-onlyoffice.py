...
if "</body>" in html:
    html = html.replace("</body>", '<script src="guangfa-outline-probe.js?gf=117"></script>\n<script src="guangfa-placeholder-fields.js?gf=31"></script>\n<script src="guangfa-layout-format.js?gf=5"></script>\n</body>')
